test_that("2D sampling square", {
  #given
  set.seed(20159)
  points1 = runif_square(478)
  points2 = runif_square(478)
  a1 = alphahull::ashape(points1, alpha=0.3)
  a2 = alphahull::ashape(points2, alpha=0.3)
  alist = list(a1, a2)
  #when
  set.seed(20159)
...
test_that("2D sampling circle", {
  #given
  set.seed(20159)
  alpha1 = truncnorm::rtruncnorm(1, a=0, b=0.5, mean=0.3, sd=0.05)
  points1 = runif_disk(14)
...
test_that("2D sampling annulus", {
  ...
  #when
  set.seed(20159)
  test1 = sampling2Dashape(N=1, n.noise=TRUE, bound="annulus", n.dependent=FALSE)
  #then
  expect_equal(list(a1), test1)
})
...
test_that("3D sampling cube", {
  #given
  set.seed(20159)
  points1 = runif_cube(6473)
  points2 = runif_cube(6473)
  a1 = alphashape3d::ashape3d(points1, alpha=0.3)
  a2 = alphashape3d::ashape3d(points2, alpha=0.3)
  alist = list(a1, a2)
  #when
  set.seed(20159)
...
test_that("2D sampling sphere", {
  #given
  set.seed(20159)
  alpha1 = truncnorm::rtruncnorm(1, a=0, b=0.5, mean=0.3, sd=0.05)
  points1 = runif_ball_3D(24)
...
test_that("3D sampling shell", {
  ...
  #when
  set.seed(20159)
  test1 = sampling3Dashape(N=1, n.noise=TRUE, bound="shell", n.dependent=FALSE)
  #then
  expect_equal(list(a1), test1)
})
...
test_that("sampling errors", {
  ...
  expect_error(sampling2Dashape(10, afixed=TRUE, alpha=10))
  ...
  expect_error(sampling3Dashape(10, afixed=TRUE, alpha=10))
